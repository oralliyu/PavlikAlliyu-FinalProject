...
Here we have created a table containing the total number of child fatalities from each state and the child fatality rate per 100,000 children. It is important to note that data for Maine and Massachusetts were not provided, but data for Puerto Rico and the District of Columbia were provided making the total number of cases 50. 
